...
<body>
            ...
            <div class="container w-50 mx-auto">
                ...
                <div class="row mt-5 mb-5   bg-gradient border-primary ">
                    ...
                    <form method="post" class=" shadow-lg p-3 mb-5 bg-white rounded   rounded-start rounded-bottom">>
                        <?php foreach ($condidat as $key => $value) : ?>
                            ...
                            <?php elseif ($key == 'message') : ?>
                                <div class="mt-3">
                                    ...
                                    <textarea <?php echo $key; ?> name="message"  id="message" class="form-control" placeholder="votre message"><?php echo $value; ?></textarea>
                                </div>
                        ...
                        <?php endforeach; ?>
                        <button onclick="
                        removedummy(); " class="btn btn-outline-secondary bg-success" id="update" type="submit" name="submit" value="Update your idea"> Update your idea</button>
                    </form>
                </div>
            </div>
    ...
    <!-- remove avec php non function -->
    <!-- <script>
        function removedummy() {
            const myDiv =document.getElementById("dummy");
